      ...
      builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (seller.status == "verified" || seller.status == "rejected") {
              return Container();
            } else {
              return Row(
                children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              ...
                              Widget continueButton = TextButton(
                                ...
                                onPressed: () {
                                  Navigator.of(context).pop();
                                  FirebaseService().approveSeller(
                                    data: {"status": "verified"},
                                    docName: seller.uid,
                                    reference: FirebaseService().seller,
                                  );
                                },
                              );
                              ...
                              AlertDialog alert = AlertDialog(
                                ...
                                content: const Text(
                                    "Would you like to approve this Seller?"),
                                actions: [
                                  cancelButton,
                                  continueButton,
                                ],
                          ...
                          TextButton(
                              onPressed: () {
                                ...
                                AlertDialog alert = AlertDialog(
                                  title: const Text("Confirmation!"),
                                  content: const Text(
                                      "Would you like to reject this Seller?"),
                                  actions: [
                                    cancelButton,
                                    continueButton,
                                  ],
